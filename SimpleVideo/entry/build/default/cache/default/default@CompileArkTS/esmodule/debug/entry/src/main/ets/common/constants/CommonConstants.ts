 ...
 * video net address
 */
export const NET: ResourceStr = { "id": 16777251, "type": 10003, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" };
/**
 * video first url
 */
export const VIDEO_FIRST_URL: ResourceStr = { "id": 16777251, "type": 10003, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" };
/**
 * video second url
 */
export const VIDEO_SECOND_URL: ResourceStr = { "id": 16777253, "type": 10003, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" };
/**
 * video third url
 */
export const VIDEO_THIRD_URL: ResourceStr = { "id": 16777255, "type": 10003, params: [], "bundleName": "com.example.simplevideo", "moduleName": "entry" };
/**
 * init time of string
 */
...
/**
 * danmaku container height
 */
export const DANMAKU_HEIGHT: number = 40;
/**
 * danmaku animation duration
 */
export const DANMAKU_DURATION: number = 10000;
/**
 * max danmaku count
 */
export const MAX_DANMAKU: number = 50;
